...
public class LeaveHistoryPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        leaveHistoryHeader = new javax.swing.JLabel();
        ...
        leaveHistoryHeader.setFont(new java.awt.Font("Poppins", 1, 20)); // NOI18N
        leaveHistoryHeader.setText("LEAVE HISTORY");
        ...
        leaveHistoryTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date Filed", "Employee ID", "Employee Name", "Subject", "Status"
            }
        ) {
        ...
        filterIDLabel.setFont(new java.awt.Font("Poppins", 1, 12)); // NOI18N
        filterIDLabel.setText("Filter by ID Number :");

        filterStatusLabel.setFont(new java.awt.Font("Poppins", 1, 12)); // NOI18N
        filterStatusLabel.setText("Filter by status type :");
    ...
    private javax.swing.JLabel filterIDLabel;
    ...
    private javax.swing.JLabel leaveHistoryHeader;
