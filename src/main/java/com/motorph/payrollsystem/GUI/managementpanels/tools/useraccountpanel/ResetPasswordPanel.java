...
public class ResetPasswordPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        resestPasswordPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, resestPasswordPanelLayout.createSequentialGroup()
                .addGap(24, 24, 24)
    ...
    private void resetBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetBtnActionPerformed
        ...
        if (newPassword.length() < 5) {
            showErrorDialog("Password must be at least 5 characters long.");
            return;
        }
