...
import com.motorph.payrollsystem.gui.rightsidepanels.*;
 ...
 * @author djjus
 */
public class PayslipViewer extends javax.swing.JPanel {
        ...
        try {
            ...
            List<PayrollPeriod> periods =
                    appContext.getPayrollService()
                            .getAvailablePayrollPeriods(selectedEmployee);
...
//        mainNetPayText.setText(Money.displayMoney(payslip.getNetPay()));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(comboBoxPeriod, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(payslipView, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void comboBoxPeriodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBoxPeriodActionPerformed
        ...
        try {
            this.payslip = this.appContext.getPayrollService().generatePayslip(selectedEmployee, selected);
            changeSalaryUI();
